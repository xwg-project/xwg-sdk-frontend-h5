...
<style scoped>
  ...
  .ToolsList >>> .el-tabs__item {
    padding: 0 20px;/*no*/
    height: 40px;/*no*/
    line-height: 40px;/*no*/
    font-size: 14px;/*no*/
  }
  .ToolsList .two .title{ height: 40px; line-height: 40px; margin-bottom: 30px; }
  .ToolsList .two .title .modify{
    color: #28c1cc;
    border-bottom: 1px solid #28c1cc;/*no*/
    cursor: pointer;
  }
  .ToolsList >>> .el-tabs__nav-wrap {
    overflow: hidden;
  ...
  .ToolsList >>> .el-tabs--card>.el-tabs__header .el-tabs__item {
    border-bottom: 1px solid transparent;/*no*/
    border-left: 1px solid #E4E7ED;/*no*/
  }
  .ToolsList >>> .el-tabs--card>.el-tabs__header .el-tabs__item.is-active {
    border-bottom-color: #FFF;
  }
  .ToolsList >>> .el-tabs--card>.el-tabs__header .el-tabs__nav {
  ...
  .ToolsList >>> .el-form .el-form-item .el-input__inner {
  ...
  .ToolsList >>> .el-input__suffix{ right: 5px;/*no*/}
  .ToolsList >>> .el-input__suffix .el-input__icon {
    height: 100%;
    width: 25px;/*no*/
    line-height: 40px;/*no*/
  }
  ...
  .page3 .ToolsList .fenye{ margin-top: 5px; text-align: center; }
  .ToolWrap .CardBox{
    width: 22%;
    float: left;
    margin: 0 1.5% 30px;
